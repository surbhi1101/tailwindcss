Build pixel-perfect food website using React, Tailwind CSS v4, and Swiper.js.
Use when user asks to build a food website from a design or description.
...
Heading font → jost
Nav links → 13px medium
Hero heading → 60px bold
Card title → 16px semibold
Meta text → 15px regular gray
