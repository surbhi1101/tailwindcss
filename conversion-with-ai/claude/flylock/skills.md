skill name: flylock
Description:
Build pixel-perfect flylock website using React, Tailwind CSS v4, and Swiper.js. Use when user asks to build a flylock website from a design or description.
...
- Headings → font-Bahnschrift ("Bahnschrift", serif)
